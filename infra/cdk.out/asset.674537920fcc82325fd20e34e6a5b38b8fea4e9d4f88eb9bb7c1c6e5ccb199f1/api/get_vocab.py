...
def lambda_handler(event, context):
    ...
    try:
        ...
        print(f"Parsed params: book_id={book_id} (type: {type(book_id)}), limit={limit}, offset={offset}")
        print(f"book_id is None? {book_id is None}")
        print(f"book_id truthiness: {bool(book_id)}")
